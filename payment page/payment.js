...
new Vue({
  ...
  submitbtn.addEventListener("click",()=>{
    // if(cname.value=="saheli"||cname.value=="Saheli"||cname.value=="SAHELI" )  swal("YOU ARE NOT THE GROUP MEMBER ANYMORE (YOU CAN CONTINUE SELLING CAKES) !!","","warning")
    // else swal("PAYMENT SUCCESSFUL","","success")
